<?php
    ...
    function checkForm() {
        global $username, $password1, $password2, $email, $flag;
...
<form class="main" action="<?php $_SERVER['SCRIPT_FILENAME']?>" method="post">
    <div class="loginFrame">
        <p class="loginTitle">Register</p>
        <div class="user">
            <label>
                <span>
                    <svg class="icon" height="20" p-id="3807" t="1586442913188" version="1.1" viewBox="0 0 1024 1024" width="20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M517.632 552.149333c-108.714667 0-197.162667-85.546667-197.162667-190.72 0-38.314667 11.690667-75.306667 33.877334-106.922666C391.04 202.026667 452.138667 170.666667 517.632 170.666667c65.408 0 126.464 31.274667 163.2 83.712 7.765333 11.093333 14.250667 22.869333 19.413333 35.072a21.333333 21.333333 0 1 1-39.338666 16.64 147.285333 147.285333 0 0 0-15.018667-27.221334C617.130667 237.824 569.173333 213.333333 517.632 213.333333c-51.626667 0-99.584 24.533333-128.426667 65.621334a143.445333 143.445333 0 0 0-26.069333 82.432c0 81.664 69.290667 148.096 154.453333 148.096 63.402667 0 119.722667-36.437333 143.36-92.8a21.333333 21.333333 0 0 1 39.338667 16.512c-30.378667 72.277333-102.016 118.954667-182.656 118.954666" fill="#ffffff" p-id="3808"></path><path d="M303.829333 627.456c-49.92 0-90.453333 41.088-90.453333 91.605333C213.333333 769.578667 253.866667 810.666667 303.786667 810.666667h416.341333C770.133333 810.666667 810.666667 769.578667 810.666667 719.061333c0-50.517333-40.533333-91.605333-90.453334-91.605333H303.786667zM720.213333 853.333333H303.829333C230.442667 853.333333 170.709333 793.088 170.709333 719.061333 170.666667 645.034667 230.4 584.789333 303.786667 584.789333h416.341333C793.6 584.789333 853.333333 645.034667 853.333333 719.061333 853.333333 793.088 793.6 853.333333 720.213333 853.333333z" fill="#ffffff" p-id="3809"></path>
                    </svg>
                </span>
                <span>用户名</span>
                <input
        ...
        <div class="password">
            <label>
                ...
                <input
                    ...
                    type="password"
                    name="password1"
                    value = <?php if($flag) echo $password1 ?>>
            </label>
        </div>
        <div class="password">
            <label>
                ...
                <input
                    ...
                    type="password"
                    name="password2"
                    value = <?php if($flag) echo $password2 ?>>
            </label>
        </div>             
        <div class="email">
            <label>
                <span>
                    <svg t="1617099095767" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2031" width="20" height="20">
                        <path d="M848.36 197.8H175.6c-35.13 0-63.6 28.43-63.6 63.6v445.2c0 35.14 28.47 63.6 63.6 63.6h672.75c35.17 0 63.64-28.46 63.64-63.6V261.4c0.01-35.17-28.46-63.6-63.63-63.6z m-7.66 36.07C715.17 359.33 566.94 523.83 547.12 539.75c-2.31 1.23-18.22 14.23-34.77 14.42-16.51 0.15-33.61-12.56-38.3-14.79-23.29-19.83-176.95-191.79-290.75-305.51h657.4z m35.1 476.68s-2.94 13.41-7.19 17.66c-4.88 4.84-20.31 6.37-20.31 6.37H175.59s-16.17-0.74-21.01-5.59c-4.06-4.06-6.37-17.4-6.37-17.4l0.52-460.47 262.54 275.14c25.75 21.98 39.8 35.84 51.94 43.89l2.2 1.56c14.91 8.57 30.7 12.86 46.32 12.86 15.46 0 30.74-4.21 44.83-12.63l2.05-2.31c26.08-16.92 122.92-124.97 317.2-319.18v460.1z" p-id="2032" fill="#ffffff"></path>
                    </svg>
                </span>
                <span>邮箱</span>
                <input
